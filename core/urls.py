...
urlpatterns = [
    ...
    path('poll-seller-log/<int:log_id>/',
         views.poll_seller_log, name='poll_seller_log'),
    path('sync-bills/', views.sync_bills, name='sync_bills'),
    path('poll-sync-log/<int:log_id>/',
         views.poll_sync_log, name='poll_sync_log'),
    path('refresh-bill/<str:bill_name>/',
         views.refresh_bill, name='refresh_bill'),
    path('sellers/', views.sellers_list, name='sellers_list'),
    path('sellers-dashboard/', views.sellers_kpi_dashboard,
         name='sellers_kpi_dashboard'),
    ...
    path('api/refresh-bill/<str:name>/',
         views.refresh_bill_ajax, name='refresh_bill_ajax'),
    ...
    path('fix-dates-progress/', views.fix_dates_progress,
         name='fix_dates_progress'),
    path('api/fix-progress/', views.get_fix_progress, name='get_fix_progress'),
    path('sync-orders/', views.sync_orders, name='sync_orders'),
    path('poll-order-log/<int:log_id>/',
         views.poll_order_log, name='poll_order_log'),
    ...
    path('orders-sync-progress/', views.orders_sync_progress,
         name='orders_sync_progress'),
    path('api/orders-sync-progress/', views.get_orders_sync_progress,
         name='get_orders_sync_progress'),
    path('seller-orders/<str:code>/', views.seller_orders, name='seller_orders'),
    path('order-detail/<str:order_id>/',
